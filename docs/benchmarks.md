...
produced by a benchmark in this repo and enforced as a CI gate. This document
...
- **Ground-truth corpus** — synthetic docs generated from code (`evals/src/corpus.ts`), so the correct markdown is exact. Authoritative; this is what the CI gates fire on.
